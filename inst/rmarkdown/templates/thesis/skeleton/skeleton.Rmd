...
chairmanname: 'Head Honcho'
chairmantitle: 'Director, Computational and Systems Biology Graduate Program'
supervisor: 'Alice Advisor'
supervisortitle: 'Professor, Civil & Environmental Engineering'
# altadvisor: ''
# altadvisortitle: ''
# Delete line 11 if you only have one advisor
committeeonename: 'Bobert Bananas'
committeeonerole: 'Chairman, Thesis Committee'
committeeonetitle: 'Professor of Biology'
committeetwoname: 'Candace Cantaloupe'
committeetworole: 'Member, Thesis Committee'
committeetwotitle: 'Associate Professor of Physics'
committeethreename: 'Daisy Dragonfruit'
committeethreerole: 'External Member, Thesis Committee'
committeethreetitle: 'Assistant Professor, Biology, Boston University'
